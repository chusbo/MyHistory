...
public class Movie_ {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (inputID.equals(adminID) && inputPW.equals(adminPW)) {
                ...
                while (true) {
                    System.out.println("1.영화예매 현황 확인하기");
                ...
                while (true) {
                    ...
                    System.out.println("1." + movieLists[0] + " | 2." + movieLists[1] + " | 3." + movieLists[2] + " | 4." + movieLists[3] + " | 5." + movieLists[4] + " | 6.예매취소 | 7.예매종료");
                    System.out.println("--------------------------------------------------------------");
                    System.out.print("선택: ");
                    ...
                    if (moviechoice >= 1 && moviechoice <= movieLists.length) {
                        ...
                        if (Pattern.matches("[0-9a-zA-Z]{4}", inputseat)) {
                            ...
                            reservations.add(new Reservation1(inputID, movieLists[moviechoice - 1].get(0), inputseat)); // 예약 정보 저장
    ...
    private static void displayReservationStatus(ArrayList<String>[] movieLists, int[] movieCounts, ArrayList<Reservation1> reservations) {
        System.out.println("---------예매현황--------");
        for (int i = 0; i < reservations.size(); i++) {
            Reservation1 reservation = reservations.get(i);
            System.out.println("아이디: " + reservation.getUserID() + ", 영화: " + reservation.getMovie() + ", 좌석번호: " + reservation.getSeat());
        }
        System.out.println();
    }

    private static void cancelReservation(ArrayList<Reservation1> reservations, int[] movieCounts, String cancelSeat, ArrayList<String>[] movieLists) {
        boolean found = false;
